...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.4\textwidth}
                \includegraphics[width=\textwidth]{hmm_plots/sirs-6-states-2-iterations.png}
                \caption{Mean values of states}
                \label{fig:states_before_train}
        \end{subfigure}
        \begin{subfigure}[b]{0.4\textwidth}
                \includegraphics[width=\textwidth]{hmm_plots/sirs-6-states-20-iterations.png}
                \caption{Mean Values (20 iterations)}
                \label{fig:states_after_train}
        \end{subfigure}
\caption{Typical change in state means before and after training.}\label{fig:states_comparison}
\end{figure}
...
\begin{figure}
        \centering
        \includegraphics[width=\textwidth]{hmm_plots/1000prediction.png}
                \caption{Precision and Recall on unseen data (15 state models, 100 training iterations)}
